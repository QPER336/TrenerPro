...
using Microsoft.AspNetCore.Identity.UI.Services; // Ważne dla emaili
...
namespace TrenerPro.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IEmailSender _emailSender; // To musimy dodać

        // Konstruktor - to tu prawdopodobnie był błąd
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Nie można utworzyć instancji '{nameof(IdentityUser)}'. " +
                    $"Upewnij się, że '{nameof(IdentityUser)}' nie jest klasą abstrakcyjną i ma bezparametrowy konstruktor.");
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Domyślny interfejs użytkownika wymaga magazynu użytkowników z obsługą poczty email.");
            }
